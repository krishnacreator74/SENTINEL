...
Used for decoupled communication between components, especially for triggering side effects like app launches or HUD updates without tight coupling to the main pipeline.
